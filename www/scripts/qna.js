...
(function (global, factory) {
...
})(this, function (exports, tfconv, tf) {
  "use strict";
  ...
  var SEP_TOKEN = "[SEP]";
  var NFKC_TOKEN = "NFKC";
  var VOCAB_URL = "../model/processed_vocab.json";
  /**
  ...
  var BertTokenizer = /** @class */ (function () {
    ...
    BertTokenizer.prototype.loadVocab = function () {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [
            2 /*return*/,
            tf.util.fetch(VOCAB_URL).then(function (d) {
              return d.json();
            }),
          ];
        });
    ...
    BertTokenizer.prototype.runSplitOnPunc = function (
      text,
      count,
      charOriginalIndex
    ) {
    ...
    BertTokenizer.prototype.tokenize = function (text) {
      ...
      words.forEach(function (word) {
        if (word.text !== CLS_TOKEN && word.text !== SEP_TOKEN) {
          word.text = ""
            .concat(SEPERATOR)
            .concat(word.text.normalize(NFKC_TOKEN));
        }
      });
  ...
  var QuestionAndAnswerImpl = /** @class */ (function () {
    function QuestionAndAnswerImpl(modelConfig) {
      ...
      if (this.modelConfig == null) {
        this.modelConfig = { modelUrl: MODEL_URL, fromTFHub: false };
      }
      if (this.modelConfig.fromTFHub == null) {
        this.modelConfig.fromTFHub = false;
      }
    }
    QuestionAndAnswerImpl.prototype.process = function (
      query,
      context,
      maxQueryLen,
      maxSeqLen,
      ...
      if (queryTokens.length > maxQueryLen) {
        throw new Error(
          "The length of question token exceeds the limit (".concat(
            maxQueryLen,
            ")."
          )
        );
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                tfconv.loadGraphModel(this.modelConfig.modelUrl, {
          ...
          switch (_a.label) {
            case 0:
              ...
              result = tf.tidy(function () {
                var inputIds = tf.tensor2d(
                  inputIdArray,
                  [batchSize, INPUT_SIZE],
                  "int32"
                );
                var segmentIds = tf.tensor2d(
                  segmentIdArray,
                  [batchSize, INPUT_SIZE],
                  "int32"
                );
                var inputMask = tf.tensor2d(
                  inputMaskArray,
                  [batchSize, INPUT_SIZE],
                  "int32"
                );
              ...
              return [
                4 /*yield*/,
                Promise.all([result[0].array(), result[1].array()]),
              ];
            case 1:
              logits = _a.sent();
     ...
     */
    QuestionAndAnswerImpl.prototype.getBestAnswers = function (
      startLogits,
      endLogits,
      origTokens,
      tokenToOrigMap,
    ...
    QuestionAndAnswerImpl.prototype.convertBack = function (
      origTokens,
      tokenToOrigMap,
      start,
      end,
