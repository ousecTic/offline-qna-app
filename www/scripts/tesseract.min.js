  ...
  return (function (e) {
    ...
    function (e, t, r) {
      ...
      e.exports = function () {
        ...
        var P = function (e, t) {
          ...
          L = function (e) {
            return E(l({ id: e, action: "load", payload: { options: c } }));
          },
          T = function (e, t, r) {
            return E(
              l({
          ...
          N = function () {
            ...
            return E(
              l({ id: r, action: "initialize", payload: { langs: e, oem: t } })
            );
          },
          F = function () {
            var e =
              ...
              t = arguments.length > 1 ? arguments[1] : void 0;
            return E(
              l({ id: t, action: "setParameters", payload: { params: e } })
            );
          },
          I = (function () {
            var e = o(
          ...
          M = function () {
            var e =
              ...
              r = arguments.length > 2 ? arguments[2] : void 0;
            return E(
              l({ id: r, action: "getPDF", payload: { title: e, textonly: t } })
            );
          },
          C = (function () {
            var e = o(
                ...
                return regeneratorRuntime.wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (e.t0 = E), (e.t1 = l), (e.t2 = r), (e.next = 5), w(t)
                        );
                      case 5:
                        return (
                          (e.t3 = e.sent),
          ...
          m(k, function (e) {
            ...
            if ("resolve" === o) {
              ...
              "recognize" === c
                ? (s = f(u))
                : "getPDF" === c &&
                  (s = Array.from(a({}, u, { length: Object.keys(u).length }))),
                y[c]({ jobId: r, data: s });
            } else if ("reject" === o) {
    ...
    function (e, t, r) {
      ...
      e.exports = (function (e) {
        ...
        { OEM: u, PSM: s, createScheduler: i, createWorker: a, setLogging: f },
        c
      );
    },
    function (e, t, r) {
            ...
            (L.prototype = {
              ...
              finish: function (e) {
                for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                  ...
                  if (r.finallyLoc === e)
                    return this.complete(r.completion, r.afterLoc), E(r), y;
                }
              },
              catch: function (e) {
                for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                          ...
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 6:
                                ...
                                break;
                              case 10:
                                (e.prev = 10), (e.t2 = e.catch(2)), l(e.t2);
                              case 13:
                                return (
                                  (e.prev = 13),
                                  delete r[a.id],
        ...
        e.exports = (function (e) {
          ...
          workerPath:
            void 0 !== t && "development" === t.env.TESS_ENV
              ...
              : "../scripts/tesseract.worker.min.js",
          corePath: "../scripts/tesseract-core.".concat(
            "object" ===
              ("undefined" == typeof WebAssembly ? "undefined" : n(WebAssembly))
              ? "wasm"
              : "asm",
            ".js"
          ),
